                    ...
                    <div class="ibox-content">
                        <input type="text" class="form-control input-sm m-b-xs" id="filter" placeholder="查询（输入要查询的关键字）">
                                ...
                                <tr>
                                    <th>知识编号</th>
                                    <th>知识名</th>
                                    <th data-hide="phone">知识类别</th>
                                    <th data-hide="phone,tablet" >上传者</th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <div class="btn-group">
                            				...
                            				<button class="btn btn-info btn-circle" type="button" onclick="window.location.href='kmCheckCatallogue.jsp'"><i class="fa fa-search"></i></button>
