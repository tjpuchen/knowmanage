                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                       <form method="get" class="form-horizontal">
										<div class="form-group">
											<label class="col-sm-1 control-label">用户工号</label>
											<div class="col-sm-3"><input id="uid" type="text" class="form-control" value="123"></div>
											<label class="col-sm-1 control-label">用户名称</label>
											<div class="col-sm-2"><input id="name" type="text" class="form-control" value="123"></div>
                                            <label class="col-sm-1 control-label">用户年龄</label>
                                            <div class="col-sm-2"><input id="age" type="text" class="form-control" value="123"></div>
										</div>
										...
										<div class="col-sm-1">
                                            ...
                                            <div class="col-sm-3">
                                                <select class="form-control m-b" name="dept" id="dept">
                                            ...
                                            <div class="col-sm-3">
                                                <select class="form-control m-b" name="rName" id="rName">
                                           ...
                                           <div class="hr-line-dashed"></div>
                                            <div class="form-group">
                                              <label class="col-sm-1 control-label">联系方式</label>
                                               <div class="col-sm-3"><input id="phone" type="text" class="form-control" value="123"></div>
                                               <label class="col-sm-1 control-label">用户密码</label>
                                               <div class="col-sm-4"><input id="password" type="text" class="form-control" value="123"></div>
                                                <input id="url" type="hidden" value="<%=path%>">
                                            </div>
        ...
        $(document).ready(function(){
        	...
        	$('.demo3').click(function () {
                var user={
                    ...
                    'user.uSex':$("#sex").val(),
                    'user.udept':$("#dept").val(),
                    'user.uRole':$("#rName").val(),
                    'user.uPhone':$("#phone").val(),
                    'user.uPassword':$("#password").val(),
                };
                var url=$("#url").val();
               ...
               type: "warning",
                ...
                closeOnCancel: false
                 ...
                 if (isConfirm) {
                     $.ajax({
                         type: 'post',
                         url: url + 'SaveUser.action',
                         contentType: 'application/json;charset=utf-8',
                         // 数据格式是json串
                         data: user,
                         // '{"user.uID":"' + uid + '","user.uName":"' + name +
                         // '","user.uAge":"' + age + '","user.uSex":"' + sex +
                         // '","user.uRole":"' + rName + '","user.udept":"' + dept +
                         // '","user.uPhone":"' + phone + '","user.uPassword":"' + password
                         // + '"}',
                         success: function (data) {// 返回json结果
                             if (data == "a") {
                                 swal("成功!", "创建成功", "success");
                                 location.href = "GotoUserManager.action"
                             } else {
                                 swal("失败", "创建失败", "error");
                             }
                         }
