                    ...
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                           ...
                           <!-- <textarea id="nestable-output" class="form-control" ></textarea>-->
                            <input id="nestable-output" class="form-control"  readonly="" />
                            <center><button class="btn btn-success btn-sm demo3" >保存</button><center>
                        </div>
                    </div>
                </div>
             ...
             $('.demo3').click(function () {
                 swal({
                     ...
                     closeOnCancel: false 
                 	 ...
                 	 if (isConfirm) {
                          swal("成功", "该目录保存成功", "success");
                          window.setTimeout("window.location='kmCatallogueManager.jsp'",2000); 
                          //location.href="";
                      }else{
                           swal("失败", "操作取消", "error");
                      }
