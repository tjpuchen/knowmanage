...
<body>
                            ...
                            <div class="dd" id="nestable">
                                <ol class="dd-list">
                                    <li class="dd-item" data-id="1">
                                        <div class="dd-handle"><a href="kmcheck.jsp">1 - Lorem ipsum</a>  
                                        	<span class="label label-primary pull-right">已通过</span>
                                        </div>
                                    </li>
                                    <li class="dd-item" data-id="2">
                                        <div class="dd-handle"><a href="jspkmcheck.jsp">2 - Dolor sit</a>  
                                        	<span class="label label-primary pull-right" >已通过</span>
                                        </div>
                                        <ol class="dd-list">
                                            <li class="dd-item" data-id="3">
                                                <div class="dd-handle"><a href="jspkmcheck.jsp">3 - Adipiscing elit</a>  
                                                	<span class="label label-primary pull-right">已通过</span>
                                                </div>
                                            </li>
                                            <li class="dd-item" data-id="4">
                                                <div class="dd-handle"><a href="jspkmcheck.jsp">4 - Nonummy nibh</a>  
                                                	<span class="label label-primary pull-right">已通过</span>
                                                </div>
                                            </li>
                                        </ol>
                                    ...
                                    <li class="dd-item" data-id="5">
                                        <div class="dd-handle"><a href="jspkmcheck.jsp">5 - Consectetuer</a>     
                                        	<span class="label label-primary pull-right">已通过</span>
                                        </div>
                                        <ol class="dd-list">
                                            <li class="dd-item" data-id="6">
                                                <div class="dd-handle"><a href="jspkmcheck.jsp">6 - Aliquam erat</a> 
                                                	<span class="label label-primary pull-right">已通过</span>
                                                </div>
                                            </li>
                                            <li class="dd-item" data-id="7">
                                                <div class="dd-handle"><a href="jspkmcheck.jsp">7 - Veniam quis</a>
                                                	<span class="label label-primary pull-right">已通过</span>
                                                </div>
                                            </li>
                                        </ol>
                                    ...
                                    <li class="dd-item" data-id="8">
                                        <div class="dd-handle"><a>8 - Tation ullamcorper</a> 
                                        	<span class="label label-primary pull-right">已通过</span>
                                        	
                                        </div>
                                    </li>
                                    <li class="dd-item" data-id="9">
                                        <div class="dd-handle"><a>9 - Ea commodo</a>
                                        	<span class="label label-primary pull-right">已通过</span>
                                        </div>
                                    </li>
                                </ol>
    ...
    <!-- Nestable List -->
    <script src="<%=path%>/js/plugins/nestable/jquery.nestable.js"></script>
