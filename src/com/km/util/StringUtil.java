...
public class StringUtil {
   ...
   public void test1(){
	 ...
	 * @return
	 */
	public static String gbkToAscii(String gbkStr){//�ַ���ת��ΪASCII��

//		  String gbkStr="������֣�";//�ַ���
           
		  char[]chars=gbkStr.toCharArray(); //���ַ���ת��Ϊ�ַ����� 
...
//       	  System.out.println(" "+chars[i]+" "+(int)chars[i]);
	 ...
	 * @return
	 */
	public static String asciiToGbk(String asciiStr){//ASCIIת��Ϊ�ַ���

//		  String asciiStr="22307 35806 24555 20048";//ASCII��
